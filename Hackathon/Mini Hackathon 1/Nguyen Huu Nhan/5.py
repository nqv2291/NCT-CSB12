...
if Answer_input == 1 and Answer == Randomize_interger1 + Randomize_interger2:
 ...
 #Moi xong:)) 9:59 14/05/2022
  import random
print ("give correct answer")
Randomize_sign = random.randint (0,3)
Randomize_interger1 = random.randint (1,30)
Randomize_interger2 = random.randint (1,30)
score = 0
Loop = 0
while Loop == 0:
    ...
    if Randomize_sign == 0:
        ...
        print (f"{Randomize_interger1} * {Randomize_interger2} = {Answer}")
    Answer_input = input("1 for True, 0 for False:")
    if Answer_input == str(0):
        if Answer == Randomize_interger1 + Randomize_interger2 or Answer == Randomize_interger1 - Randomize_interger2 or Answer == Randomize_interger1 * Randomize_interger2:
            print ("Lost")
            Loop = Loop + 1
        else:
            score = score + 1
            print (f"ur score is {score}")
    elif Answer_input == str(1):
        if Answer == Randomize_interger1 + Randomize_interger2 or Answer == Randomize_interger1 - Randomize_interger2 or Answer == Randomize_interger1 * Randomize_interger2:
            score = score + 1
            print (f"ur score is {score}")
        else:
